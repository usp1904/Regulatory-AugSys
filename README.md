...
| MVP-17 | SOP and policy mapper | **Readiness** tab maps curated regulations to Client process delta / audit gap / ingested SOP text; flags unmapped controls and lexical conflicts |
