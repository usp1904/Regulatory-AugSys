...
check('Regulatory Library keeps 24px space between tree and sidebar scrollbars', html.includes('id="sb-resizer"') && html.includes('function initSidebarResize') && html.includes('margin-right:24px') && html.includes('.sb-tree::-webkit-scrollbar{width:14px') && html.includes('.sb-scroll::-webkit-scrollbar{width:14px') && !html.includes('sb-split-gap'));
