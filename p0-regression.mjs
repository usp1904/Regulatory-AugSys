...
check('Regulatory Library has a usable resize handle and one library scrollbar', html.includes('id="sb-resizer"') && html.includes('function initSidebarResize') && html.includes('.sb-tree{flex:none;overflow:visible') && html.includes('.sb-scroll::-webkit-scrollbar{width:12px}'));
