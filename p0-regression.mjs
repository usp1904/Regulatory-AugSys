...
check('framework and jurisdiction filters are multi-select', html.includes('id="ch-framework"') && html.includes('id="ch-jurisdiction"') && html.includes('function toggleFramework') && html.includes('function applySelectedFrameworks') && html.includes('function getSelectedFrameworks') && html.includes("id=\"f-fw\" multiple") && html.includes("id=\"f-jurisdiction\" multiple") && !html.includes('if(selFrameworks.size===1) return') && !html.includes('if(selJurisdictions.size===1) return'));
