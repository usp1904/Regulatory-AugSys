...
check('Regulatory Library has separated tree and sidebar scrollbars with a resize handle', html.includes('id="sb-resizer"') && html.includes('function initSidebarResize') && html.includes('sb-tree-row') && html.includes('sb-split-gap') && html.includes('.sb-split-gap{width:10px') && html.includes('.sb-tree{flex:1 1 auto;min-width:0;min-height:180px;overflow-y:scroll') && html.includes('.sb-scroll::-webkit-scrollbar,.sb-tree::-webkit-scrollbar{width:12px}'));
